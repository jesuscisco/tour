...
const HOTSPOTS_MAP: Record<string, HotspotData[]> = {
  '/panoramas/entrada.png': [
    { id: 'to-13', position: [800, -50, 50], label: 'Ir a 1', target: '/panoramas/13.png' },
  ],
  '/panoramas/13.png': [
    { id: 'to-entrada', position: [-900, -80, -220], label: 'Ir a entrada', target: '/panoramas/entrada.png' },
    { id: 'to-2', position: [500, -80, 500], label: 'Ir a 2', target: '/panoramas/14.png' },
    { id: 'to-2b', position: [-7, -1.4, 10], label: 'Ir a 2b', target: '/panoramas/11.png' },
  ],
  '/panoramas/11.png': [
    { id: 'to-1-again', position: [-90, -0, 100], label: 'Ir a 1', target: '/panoramas/13.png' },
  ],
  '/panoramas/14.png': [
    { id: 'to-1', position: [-200, -10, 100], label: 'ir a 1', target: '/panoramas/13.png' },
    { id: 'to-3', position: [50, 0, -180], label: 'ir a 3', target: '/panoramas/3.png' },
    { id: 'to-4', position: [50, 0, 0], label: 'ir a 4', target: '/panoramas/4.png' },
    { id: 'to-5', position: [700, 0, 600], label: 'ir a 5', target: '/panoramas/15.png' },
    
  ],
  '/panoramas/3.png': [
    { id: 'to-2-again', position: [700, 0, 200], label: 'Ir a 1', target: '/panoramas/14.png' },
  ...
  '/panoramas/4.png': [
    { id: 'to-2-again', position: [-80, -5, -3], label: 'Ir a 1', target: '/panoramas/14.png' },
  ],
  '/panoramas/15.png': [
    { id: 'to-6', position: [400, 150, -200], label: 'Ir a 1', target: '/panoramas/16.png' },
    { id: 'to-2-again', position: [500, -400, 50], label: 'Ir a 1', target: '/panoramas/14.png' },
  ],
  '/panoramas/16.png': [
    { id: 'to-5-again', position: [500, 0, 50], label: 'Ir a 1', target: '/panoramas/15.png' },
  ...
  '/panoramas/7.png': [
    { id: 'to-6', position: [-180, 0, 500], label: 'Ir a 1', target: '/panoramas/16.png' },
  ],
  '/panoramas/8.png': [
    { id: 'to-6-again', position: [-400, 20, 170], label: 'Ir a 1', target: '/panoramas/16.png' },
